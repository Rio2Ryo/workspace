...
const imgs = {
  cover: 'slide-tool/out/kataomoi-premium-visual/assets-compressed/kataomoi-cover-premium---0471834e-4830-4976-b6c1-fb6b835e210e.jpg',
  nfc: 'slide-tool/out/kataomoi-premium-visual/assets-compressed/kataomoi-nfc-touch-premium---f75ca4c4-eb0f-4e10-a1a4-577fcd9c8403.jpg',
  network: 'slide-tool/out/kataomoi-premium-visual/assets-compressed/kataomoi-network-premium---625d7c94-5da5-4ba4-a444-c0ee2a2de1e3.jpg',
  apps: 'slide-tool/out/kataomoi-premium-visual/assets-compressed/kataomoi-ai-apps-premium---2ec5524e-7289-4f50-90a6-4db38335659d.jpg',
};
...
await pptx.writeFile({ fileName: path.join(outDir,'kataomoi-premium-visual-light.pptx') });
console.log(JSON.stringify({ pptx: path.join(outDir,'kataomoi-premium-visual-light.pptx'), slides: pptx._slides.length }, null, 2));
