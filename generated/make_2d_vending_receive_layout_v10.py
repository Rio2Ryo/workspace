...
OUT = '/Users/umi/.openclaw/workspace/generated/2d-vending-machine-receive-options-v10-a4.png'
...
# 1) 赤丸指定箇所: 自販機下部の中央ラベル「2D自販機」を削除
# レール自体は残して、文字だけ自然に消す
label_cover = (500, 972, 740, 1014)
d.rounded_rectangle(label_cover, radius=12, fill=(236, 244, 249))
d.line((label_cover[0]+12, label_cover[1]+4, label_cover[2]-12, label_cover[1]+4), fill=(255,255,255), width=2)
d.line((label_cover[0]+12, label_cover[3]-4, label_cover[2]-12, label_cover[3]-4), fill=(178,196,210), width=2)
