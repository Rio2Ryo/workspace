...
test('import validation field filter keeps aria-pressed and filtered status in sync', async ({ page }) => {
  await page.goto('/')
  ...
  await uploadJsonImportFile(page, 'invalid-filter-a11y-pressed-state.json', invalidItems)
