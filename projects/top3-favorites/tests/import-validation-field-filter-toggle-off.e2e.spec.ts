...
test('clicking the active import validation field filter again toggles back to all issues', async ({ page }) => {
  await page.goto('/')
  ...
  await uploadJsonImportFile(page, 'invalid-filter-toggle-off.json', invalidItems)
